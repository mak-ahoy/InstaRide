        ...
        <header className="absolute inset-x-0 top-0">
          {/* <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              ...
              <a href="#" className="text-sm font-semibold leading-6 text-gray-900">App</a>
          ...
          <div className={`lg:hidden fixed inset-0 z-50 transition-transform duration-300 ${isSidebarOpen ? '' : 'transform -translate-x-full'}`}>
            ...
            <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="-m-2.5 rounded-md p-2.5 text-gray-700" onClick={closeSidebar}>
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Revolutionize Your Rideshare Experience With InstaRide
